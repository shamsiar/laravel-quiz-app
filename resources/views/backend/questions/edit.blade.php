    ...
    <div class="card border-top border-0 border-4 border-primary">
        <div class="card-body p-5">
            <div class="card-title d-flex align-items-center">
                ...
                <h5 class="mb-0 text-primary">Update Question Form</h5>
            </div>
            <hr>

            <form action="{{ route('questions.update', $question->id) }}" method="POST" enctype="multipart/form-data" class="row g-3 needs-validation" novalidate>

                @csrf
                @method('PUT')

                <input type="hidden" name="is_image" value="{{ $question->is_image }}">
                <div class="col-12">
                    <label for="question" class="form-label">Question</label>
                    <div class="input-group">
                        <input type="text" class="form-control border-start-0" id="question" name="question" value="{{ $question->question }}" required>
                ...
                <div class="row row my-2 border p-2" style="border-radius:10px;">
                    <div class="col-6">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control border-start-0" id="option_1" name="option_1" value="{{ $question->option_1 }}">
                ...
                <div class="row row my-2 border p-2" style="border-radius:10px;">
                    <div class="col-6">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control border-start-0" id="option_2" name="option_2" value="{{ $question->option_2 }}">
                ...
                <div class="row row my-2 border p-2" style="border-radius:10px;">
                    <div class="col-6">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control border-start-0" id="option_3" name="option_3" value="{{ $question->option_3 }}">
                ...
                <div class="row row my-2 border p-2" style="border-radius:10px;">
                    <div class="col-6">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control border-start-0" id="option_4" name="option_4" value="{{ $question->option_4 }}">
                            <div class="invalid-feedback">Please Enter a Valid Option.</div>
                        </div>
                    </div>
                    <div class="col-6">
                ...
                <div class="col-4">
                    ...
                    <select class="form-select" id="test_id" name="test_id" required>
                        ...
                        <option value="{{ $test->id }}" @if ($question->test_id == $test->id) selected @endif>
                            {{ $test->title }}</option>
                        @endforeach
                    </select>
